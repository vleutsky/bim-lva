...
### Ответы слабые / пустые actions
- выделите элементы на сцене и уточните запрос  
- возьмите модель крупнее (`qwen2.5:14b`)  
- ИИ знает только то, что есть в JSON-контексте
