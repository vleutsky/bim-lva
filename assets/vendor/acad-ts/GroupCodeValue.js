...
export class GroupCodeValue {
    static isValidCode(code, value) {
        return GroupCodeValue.isValidGroupCode(GroupCodeValue.transformValue(code), value);
    }
    static isValidGroupCode(groupCode, value) {
        switch (groupCode) {
...
//# sourceMappingURL=GroupCodeValue.js.map